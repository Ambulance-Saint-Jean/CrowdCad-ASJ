...
Feature: Clinic operations on the dispatch board
  ...
  Scenario: Delivered call appears in clinic tracking
    ...
    And I log a call assigned to team "ClinicTeam" at location "Stage" with complaint "Syncope" and priority "P2 - Medium"
  ...
  Scenario: Clinic outcome can be set to Discharged
    ...
    And I open the quick call modal
    And I log a call assigned to team "ClinicTeam2" at location "VIP" with complaint "Laceration" and priority "P1 - High"
  ...
  Scenario: Clinic outcome can be set to AMA
    ...
    And I open the quick call modal
    And I log a call assigned to team "ClinicTeam3" at location "Gate A" with complaint "Nausea" and priority "P3"
